...
ColumnLayout {
    ...
    Item {
        ...
        Loader {
            ...
            sourceComponent: hostPropertyComponent // selectedHostAddress > 0 ? hostPropertyComponent : emptyComponent
        }
    }

    // ========== 主机属性显示组件 ==========
    Component {
        id: hostPropertyComponent

        Rectangle {
            id: propertyRect
            color: "transparent"  // 淡蓝色背景
            border.color: Theme.borderLine
            border.width: 0
            Layout.margins: 5
            radius: 2
            ...
            // 🔥 直接获取控制器和属性（简化版）
            property var controller: selectedHostAddress > 0 ?
                hostManager.getController(selectedHostAddress) : null
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    Label {
                        text: "0x" + (selectedHostAddress ? selectedHostAddress.toString(16).toUpperCase().padStart(2, '0') : "00")
                        color: Theme.warning
                        font.pixelSize: 12
                        font.bold: true
                        Layout.preferredWidth: 120
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.systemDatetime || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    }
                    Item { Layout.columnSpan: 4 }   // 占位
                }
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" // currentHostInfo ? (currentHostInfo.speechMode || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.maxSpeechUnits || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.wirelessVolume || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.wiredVolume || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.antaBoxVolume || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.wirelessAudioPath || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.monitorAudioChannels || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.unitCapacity || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                ...
                GridLayout {
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.cameraTrackingProtocol || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? (currentHostInfo.cameraTrackingAddress || "--") : "--"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
                    ...
                    Label {
                        text: "" //currentHostInfo ? ((currentHostInfo.cameraTrackingBaudrate || "--") + " bps") : "-- bps"
                        color: Theme.text
                        font.pixelSize: 11
                        font.weight: 11
                        Layout.preferredWidth: 80 * 2
    ...
    // 监听 XdcController 的 hostPropertiesUpdated 信号
    // Connections {
    //     target: selectedHostAddress > 0 ? hostManager.getController(selectedHostAddress) : null

    //     // 当控制器的 hostProperties 更新时，强制刷新界面
    //     function onHostPropertiesUpdated() {
    //         // console.log("主机属性更新，地址：0x" + selectedHostAddress.toString(16).toUpperCase())
    //         // 通过临时重置来触发 QML 重新绑定
    //         var temp = propertyLoader.sourceComponent
    //         propertyLoader.sourceComponent = null
    //         propertyLoader.sourceComponent = temp
    //     }
    // }
